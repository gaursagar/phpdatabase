        ...
        <ul class="nav navbar-nav nav">
          ...
          <li class="dropdown active">
            ...
            <ul class="dropdown-menu ">
              ...
              <li class="active"><a href="createproduct.php">Add New Product</a></li>
            </ul>
          </li>
          <li class="dropdown">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 centered">
                        <form action = "addproduct.php" class="well" method = "POST">
                            ...
                            <div class="form-group">
                                <label>Project</label>
                                <input type="text" class="form-control" name= "project_id" placeholder="ProjectID">
                            </div>
